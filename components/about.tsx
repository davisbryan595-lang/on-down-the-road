  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-black relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-96 h-96 bg-red-600/4 rounded-full blur-3xl top-1/3 right-1/4" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-in-up">
            <h2 className="text-4xl sm:text-5xl font-black text-white mb-6">
              Meet <span className="text-red-600">Terrence Flynn</span>
            </h2>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-red-600/20 to-blue-900/20 rounded-lg p-8 border border-red-600/30 hover:border-red-600/60 transition-all duration-300">
